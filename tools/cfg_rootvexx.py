...
CFG = dict(
    ...
    title="RootVexx — Mini Excavators, Dumpers, Chippers & Stump Grinders, Free UK Delivery",
    desc="Mini excavators, tracked mini dumpers, petrol wood chippers and stump grinders for UK "
         "groundworkers, tree surgeons and landscapers. Free mainland delivery, 30-day returns, "
         "2-year warranty.",
    ...
    hero_lead="Four machines picked because between them they finish the job: a mini excavator "
              "705 mm across the tracks, a 500 kg tracked dumper that clears a 715 mm gap, a petrol "
              "wood chipper on two wheels and a Honda-powered stump grinder. All four in UK stock, "
              "all four delivered free to the mainland, all four movable by one person and a van.",
    ...
    range_lead="Dig it out, barrow it away, chip what came off the trees and grind out what is left "
               "in the ground. Four machines that cover a whole job instead of one stage of it.",
