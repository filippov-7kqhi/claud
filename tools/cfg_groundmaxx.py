...
CFG = dict(
    ...
    about_images=[
        ("assets/img/vhf71/01-hero.jpg", "GroundMaxx VHF71 hydraulic offset ditch bank flail mower"),
        ("assets/img/lfs53/01-hero.jpg", "GroundMaxx LFS53 53-inch 3-point flail mower"),
        ("assets/img/phd18/01-hero.jpg", "GroundMaxx PHD18 3-point post hole digger"),
        ("assets/img/rc72/01-hero.jpg", "GroundMaxx RC72 6 ft. round-back rotary cutter")],
